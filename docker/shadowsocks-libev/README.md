## Shadowsocks-libev Docker Image by Dev800
...
```bash
$ docker pull dev800/shadowsocks-libev
```

or pull image based **alpine**

```bash
$ docker pull dev800/shadowsocks-libev:alpine
```
...
```bash
$ docker run -d -p 9000:9000 -p 9000:9000/udp --name ss-libev -v /etc/shadowsocks-libev:/etc/shadowsocks-libev dev800/shadowsocks-libev
```

There is an example to start a container based **alpine** that listens on `9000` (both TCP and UDP):

```bash
$ docker run -d -p 9000:9000 -p 9000:9000/udp --name ss-libev -v /etc/shadowsocks-libev:/etc/shadowsocks-libev dev800/shadowsocks-libev:alpine
```
...
[5]: https://hub.docker.com/r/dev800/shadowsocks-libev/
