...
#   Author: Dev800 <i@dev800.com>                             #
#   Thanks: @clowwindy <https://twitter.com/clowwindy>            #
#   Intro:  https://dev800.com/342.html                         #
#=================================================================#
...
echo "# Intro: https://dev800.com/342.html                      #"
echo "# Author: Dev800 <i@dev800.com>                         #"
...
download_files(){
    ...
    if check_sys packageManager yum; then
        if ! wget --no-check-certificate https://raw.githubusercontent.com/dev800/shadowsocks_install/master/shadowsocks -O /etc/init.d/shadowsocks; then
            echo -e "[${red}Error${plain}] Failed to download shadowsocks chkconfig file!"
            exit 1
        fi
    elif check_sys packageManager apt; then
        if ! wget --no-check-certificate https://raw.githubusercontent.com/dev800/shadowsocks_install/master/shadowsocks-debian -O /etc/init.d/shadowsocks; then
            echo -e "[${red}Error${plain}] Failed to download shadowsocks chkconfig file!"
            exit 1
        fi
    fi
...
install(){
    ...
    if [ -f /usr/bin/ssserver ] || [ -f /usr/local/bin/ssserver ]; then
        ...
        echo
        echo -e "[${red}Error${plain}] Shadowsocks install failed! please visit https://dev800.com/342.html and contact."
        install_cleanup
        exit 1
    fi
    ...
    echo
    echo "Welcome to visit:https://dev800.com/342.html"
    echo "Enjoy it!"
    echo
}
