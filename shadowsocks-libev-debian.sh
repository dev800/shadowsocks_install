...
#   Intro:  https://dev800.com/358.html                           #
#===================================================================#
...
get_latest_version(){
    ...
    init_script_link="https://raw.githubusercontent.com/dev800/shadowsocks_install/master/shadowsocks-libev-debian"
}
...
print_info(){
    ...
    echo "# Intro:  https://dev800.com/358.html                     #"
...
install_shadowsocks(){
    ...
    if [ $? -eq 0 ]; then
        ...
        echo
        echo -e "[${red}Error${plain}] Shadowsocks-libev install failed. please visit https://dev800.com/358.html and contact."
        exit 1
    fi
    ...
    echo
    echo "Welcome to visit:https://dev800.com/358.html"
    echo "Enjoy it!"
    echo
}
