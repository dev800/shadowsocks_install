...
#   Intro:  https://dev800.com/357.html                           #
#===================================================================#
...
get_latest_version(){
    ...
    init_script_link="https://raw.githubusercontent.com/dev800/shadowsocks_install/master/shadowsocks-libev"
}
...
print_info(){
    ...
    echo "# Intro:  https://dev800.com/357.html                     #"
...
install_shadowsocks(){
    ...
    if [ $? -eq 0 ]; then
        ...
        echo
        echo -e "[${red}Error${plain}] Shadowsocks-libev install failed. please visit https://dev800.com/357.html and contact."
        exit 1
    fi
    ...
    echo
    echo "Welcome to visit:https://dev800.com/357.html"
    echo "Enjoy it!"
    echo
}
